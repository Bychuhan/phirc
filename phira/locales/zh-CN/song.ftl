...
upload-rules-content =
  ...
  2. 建议使用辨识度高的头像和 ID；如果你在 Phirc 使用的头像 ID 与自制谱视频发布平台（具体而言，BiliBili）有较大出入，需要额外标注。同时请注明方便使用的语言（若非汉语）
  3. 谱面内容（包括音乐、插图、文字等）须符合中华人民共和国其他法律法规，不得违法或包含不良信息
  4. 上传者上传即同意谱面可用于 Phirc 的公开宣传，其他方式利用仍需谱师许可
  5. 本须知最终解释权归 TeamFloc 所有
uploading = 上传中…

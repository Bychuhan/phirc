...
item-speed = 速度
item-note-size = 音符大小
item-combo-tip = COMBO提示
item-combo-tip-sub = 修改combo数字下方的文本，默认为"COMBO"
...
item-enable-custom-character = 启用自定义角色
item-custom-character-path = 自定义角色路径
item-custom-character-name = 自定义角色名称
item-custom-character-intro = 自定义角色介绍
...
about-content =
  ...
  Phirc 是一款玩法基于 Phigros 的非商业社区音乐游戏，使用 Rust 开发。

  BiliBili 账号：@Phirc官方（然而并没有这个账号）
  QQ 频道：r48eajexth（这是phira的频道）

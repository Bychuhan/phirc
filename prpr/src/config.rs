...
pub struct Config {
    ...
    pub volume_sfx: f32,
    pub volume_bgm: f32,
    pub combo_tip: String,
    pub enable_custom_character: bool,
    pub custom_character_path: String,
    pub custom_character_name: String,
    pub custom_character_intro: String,
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            volume_sfx: 1.,
            volume_bgm: 1.,
            combo_tip: "COMBO".to_owned(),
            enable_custom_character: false,
            custom_character_path: "".to_owned(),
            custom_character_name: "".to_owned(),
            custom_character_intro: "".to_owned(),

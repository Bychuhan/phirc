...
#[inline]
fn default_hit_perfect() -> u32 {
    0xffffeca0
}

#[inline]
fn default_hit_good() -> u32 {
    0xffb4e1ff
}
...
pub struct ResPackInfo {
    ...
    #[serde(default = "default_hit_perfect")]
    pub hit_color_perfect: u32,
    #[serde(default = "default_hit_good")]
    pub hit_color_good: u32,
...
impl ResPackInfo {
    pub fn fx_perfect(&self) -> Color {
        if self.hit_fx_tinted {
            ...
            Color::from_hex(self.hit_color_perfect)
        }
    }
    ...
    pub fn fx_good(&self) -> Color {
        if self.hit_fx_tinted {
            ...
            Color::from_hex(self.hit_color_good)
        }
    }
}
...
pub struct Resource {
    ...
    pub icon_pause_back: SafeTexture,
    pub icon_pause_retry: SafeTexture,
    pub icon_pause_resume: SafeTexture,
...
impl Resource {
    ...
    pub async fn new(
        ...
        Ok(Self {
            ...
            icon_pause_back: load_tex!("pause_back.png"),
            icon_pause_retry: load_tex!("pause_retry.png").with_mipmap(),
            icon_pause_resume: load_tex!("pause_resume.png"),
